...
class Tag(BaseModel, Base):
    ...
    tag_article_associations = relationship(
        "TagArticleAssociation", back_populates="tag", cascade="all, delete"
    )
    tag_like_associations = relationship(
        "TagLikeAssociation", back_populates="tag", cascade="all, delete"
    )
    tag_dislike_associations = relationship(
        "TagDislikeAssociation", back_populates="tag", cascade="all, delete"
    )
...
class TagArticleAssociation(Base):
    ...
    tag = relationship("Tag", back_populates="tag_article_associations")
...
class TagLikeAssociation(Base):
    ...
    user = relationship("User", back_populates="user_tag_like_associations")
...
class TagDislikeAssociation(Base):
    ...
    user = relationship("User", back_populates="user_tag_dislike_associations")
