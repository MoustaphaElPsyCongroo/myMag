...
class TestFeed(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        user = User(
            email="email@mail.mail", name="Test user", profile_pic="pic"
        )
    ...
    def test_get_user_feeds(self):
        ...
        feed1 = Feed(name="Test feed", link="link")
        feed2 = Feed(name="Test feed2", link="link2")
    ...
    def test_subscribe_user_to_feed(self):
        ...
        feed = Feed(name="Test feed", link="link")
        ...
        req = requests.post(
            f"{BACKEND_URL}/users/{user_id}/feeds", json={"feed_id": feed_id}
        )
